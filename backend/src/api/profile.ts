...
export const getProfile = async (c: Context<{ Bindings: Env }>) => {
  try {
    ...
    return c.json({ error: error instanceof Error ? error.message : 'Failed to get profile' }, 400);
  }
};
...
export const getMyProfile = async (c: Context<{ Bindings: Env }>) => {
  try {
    ...
    return c.json({ error: error instanceof Error ? error.message : 'Failed to get profile' }, 500);
  }
};
...
export const updateMyProfile = async (c: Context<{ Bindings: Env }>) => {
  try {
    ...
    return c.json({ error: error instanceof Error ? error.message : 'Failed to update profile' }, 400);
  }
};
...
export const uploadProfileAvatar = async (c: Context<{ Bindings: Env }>) => {
  try {
    ...
    return c.json({ error: error instanceof Error ? error.message : 'Failed to upload avatar' }, 500);
  }
};